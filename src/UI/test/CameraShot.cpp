...
void CameraShot::initViewer()
{
    ...
    m_pSoftTriggerAction = new QAction(QStringLiteral("Trigger"), this);
    connect(m_pSoftTriggerAction, &QAction::triggered, this, &CameraShot::softTrigger);

    m_pOpenImage = new QAction(QStringLiteral("OpenImage"), this);
...
void CameraShot::paintEvent(QPaintEvent * event)
{
	...
	if (m_result == "OK")
	{
        painter.drawText(10, 90, QStringLiteral("Result: ") + m_result);
	}
	else
	{
