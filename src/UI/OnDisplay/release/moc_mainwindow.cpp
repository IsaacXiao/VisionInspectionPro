...
QT_MOC_LITERAL(5, 54, 12), // "DisplayImage"
QT_MOC_LITERAL(6, 67, 3), // "pos"
QT_MOC_LITERAL(7, 71, 10), // "ImgTypePtr"
QT_MOC_LITERAL(8, 82, 3) // "img"

    },
    "MainWnd\0OnNavBtnClick\0\0OnStartBtnClick\0"
    "OnStopBtnClick\0DisplayImage\0pos\0"
    "ImgTypePtr\0img"
};
...
static const uint qt_meta_data_MainWnd[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void, QMetaType::UShort, 0x80000000 | 7,    6,    8,
...
void MainWnd::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->DisplayImage((*reinterpret_cast< unsigned short(*)>(_a[1])),(*reinterpret_cast< ImgTypePtr(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
void *MainWnd::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IForDisplay"))
        return static_cast< IForDisplay*>(this);
