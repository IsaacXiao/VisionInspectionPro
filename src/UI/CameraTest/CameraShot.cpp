...
void CameraShot::paintEvent(QPaintEvent * event)
{
	...
	//使图片自适应窗口大小
	m_backImage.scaled(width(), height(), Qt::KeepAspectRatio, Qt::SmoothTransformation);
	setScaledContents(true);
	setPixmap(QPixmap::fromImage(m_backImage));
	...
	for (int i = 0; i < m_regionRect.size(); i++)
	{
	...
	painter.drawText(10, 50, Gb2312ToUnicode("通讯状态: ") + m_commResult);
	painter.drawText(10, 130, Gb2312ToUnicode("检测总数: ") + m_detectNum);
	if (m_result == "OK")
	{
		painter.drawText(10, 90, Gb2312ToUnicode("检测结果: ") + m_result);
	}
	else
	{
	...
	//	painter.drawText(10, 280, Gb2312ToUnicode("通讯状态: ") + m_commResult);
	//	painter.drawText(10, 300, Gb2312ToUnicode("检测结果: ") + m_result);
	//	painter.drawText(10, 320, Gb2312ToUnicode("瑕疵类型: ") + m_resultType);
	//	painter.drawText(10, 340, Gb2312ToUnicode("检测总数: ") + m_detectNum);
	//	painter.drawText(200, 280, Gb2312ToUnicode("检测OK数: ") + m_detectOkNum);
	//	painter.drawText(200, 300, Gb2312ToUnicode("检测NG数: ") + m_detectNgNum);
	//	painter.drawText(200, 320, Gb2312ToUnicode("检测TBA数: ") + m_detectTbaNum);
	//}
	//else
	//{
	//	font3.setPixelSize(16);
	//	painter.setFont(font3);
	//	painter.drawText(10, 420, Gb2312ToUnicode("通讯状态: ") + m_commResult);
	//	painter.drawText(10, 440, Gb2312ToUnicode("检测结果: ") + m_result);
	//	painter.drawText(10, 460, Gb2312ToUnicode("瑕疵类型: ") + m_resultType);
	//	painter.drawText(10, 480, Gb2312ToUnicode("检测总数: ") + m_detectNum);
	//	painter.drawText(200, 420, Gb2312ToUnicode("检测OK数: ") + m_detectOkNum);
	//	painter.drawText(200, 440, Gb2312ToUnicode("检测NG数: ") + m_detectNgNum);
	//	painter.drawText(200, 460, Gb2312ToUnicode("检测TBA数: ") + m_detectTbaNum);
	//}
